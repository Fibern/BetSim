...
sealed class Screen(val route: String) {
    ...
    data object TodayTournamentsScreen: Screen("today_events_screen?today={today}")
    data object TournamentDetailScreen: Screen("event_detail_screen")
    data object TodayTournamentDetailScreen: Screen("today_event_detail_screen")
