...
class CouponsScreenViewModel @Inject constructor(
    ...
    init {
        ...
        val game1 = TournamentGame(1,"Polska", "Mołdawia", listOf(odd1,odd2,odd3), selected = mutableStateOf(0))
        val game2 = TournamentGame(2,"Polska", "Estonia", listOf(odd1,odd2,odd3), selected = mutableStateOf(2))
        val game3 = TournamentGame(3,"Polska", "Estonia", listOf(odd1,odd2,odd3), selected = mutableStateOf(1))
        val game4 = TournamentGame(4,"Polska", "Estonia", listOf(odd1,odd2,odd3), selected = mutableStateOf(2))
        val game5 = TournamentGame(5,"Polska", "Estonia", listOf(odd1,odd2,odd3), selected = mutableStateOf(1))
