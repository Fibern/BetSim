...
sealed class Screen(val route: String) {
    ...
    data object TournamentDetailScreen: Screen("tournament_detail_screen?today={today}mod={mod}")
    data object TodayTournamentDetailScreen: Screen("today_tournament_detail_screen?today={today}mod={mod}")
